 ...
 * @since 1.0.0
 */
abstract class Field extends Component implements LabelSupport, PlaceholderSupport,
        ValueSupport, ValiditySupport, FocusSupport, Clearable, EmptySupport, ReadOnlySupport, RequiredSupport {
    abstract void value(Object value)
}