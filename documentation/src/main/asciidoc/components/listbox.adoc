=== ListBox
[.thumb]
image:../images/components/ListBox_1.png[ListBox]
image:../images/components/ListBox_2.png[ListBox]

[IMPORTANT]
====
*The second image shows all the items available in the ListBox.*
====
...
----
include::{codepath}/../../../../test/groovy/sc/tyro/doc/componentsTest.groovy[tags=listbox]
----
